...
function Dropdown ({filteredOptions, selected, setSelected, term, setTerm, isActive, setIsActive, showFlags, multiselect}) {
	...
	return (
		<div className={classes.dropdown}>
			...
			<TriggerButton selected={selected} setSelected={setSelected} setIsActive={setIsActive} isActive={isActive} multiselect={multiselect} toggleActive={toggleActive}/>
			{isActive && (
				<div className={classes.content}>
					<SearchField term={term} setTerm={setTerm} isActive={isActive}/>
